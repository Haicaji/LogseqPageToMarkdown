...
- 知道了 `Here String语法` 和 `$0`的用法, 就可以开始调整命令的解析顺序
	...
	- 最后得到如下 Payload: `$0<<<$\'\\$(($((1<<1))#10011010))\\$(($((1<<1))#10100011))\'`
		...
		- ![image.png](https://haicaji.github.io/assets/image_1741751982469_0.png)
...
- 尝试构建获取flag的Payload
	...
	- 运行->报错了?
		...
		- ![image.png](https://haicaji.github.io/assets/image_1741756378022_0.png)
...
- 直接使用工具获取 Payload
	...
	- ![image.png](https://haicaji.github.io/assets/image_1741756834698_0.png)
...
- ![image.png](https://haicaji.github.io/assets/image_1741760352214_0.png)
